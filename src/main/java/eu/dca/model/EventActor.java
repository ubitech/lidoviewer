 ...
 * with role information (participating or being present in the
 * event).How to record: For multiple actors repeat the element.
 * 
 * @version $Revision$ $Date$
 */
@SuppressWarnings("serial")
public class EventActor extends eu.dca.model.ActorInRoleSetComplexType 
implements java.io.Serializable
{
     ...
     * @throws org.exolab.castor.xml.ValidationException if this
     * object is an invalid instance according to the schema
     * @return the unmarshaled eu.dca.model.EventActor
     */
    public static eu.dca.model.EventActor unmarshal(
            final java.io.Reader reader)
    throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (eu.dca.model.EventActor) org.exolab.castor.xml.Unmarshaller.unmarshal(eu.dca.model.EventActor.class, reader);
    }
