 ...
 * description.Notes: Provides identification of a surrogate of the
 * object / work including digital images, slides, transparencies,
 * photographs, audio, video and moving images, but excluding items
 * that are considered object / works in their own right. For such
 * as drawings, prints, paintings, or photographs considered art,
 * and other works that themselves contain representations of other
 * works, use Related Works and/or Subjects. 
 * 
 * @version $Revision$ $Date$
 */
@SuppressWarnings("serial")
public class ResourceSet extends eu.dca.model.ResourceSetComplexType 
implements java.io.Serializable
{
     ...
     * @throws org.exolab.castor.xml.ValidationException if this
     * object is an invalid instance according to the schema
     * @return the unmarshaled eu.dca.model.ResourceSet
     */
    public static eu.dca.model.ResourceSet unmarshal(
            final java.io.Reader reader)
    throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (eu.dca.model.ResourceSet) org.exolab.castor.xml.Unmarshaller.unmarshal(eu.dca.model.ResourceSet.class, reader);
    }
