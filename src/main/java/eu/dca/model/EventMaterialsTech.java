...
/**
 * Definition: Indicates the substances or materials used within
 * the event (e.g. the creation of an object / work), as well as
 * any implements, production or manufacturing techniques,
 * processes, or methods incorporated.How to record: Will be used
 * most often within a production event, but also others such as
 * excavation, restoration, etc. 
 * 
 * @version $Revision$ $Date$
 */
@SuppressWarnings("serial")
public class EventMaterialsTech extends eu.dca.model.MaterialsTechSetComplexType 
implements java.io.Serializable
{
     ...
     * @throws org.exolab.castor.xml.ValidationException if this
     * object is an invalid instance according to the schema
     * @return the unmarshaled eu.dca.model.EventMaterialsTech
     */
    public static eu.dca.model.EventMaterialsTech unmarshal(
            final java.io.Reader reader)
    throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (eu.dca.model.EventMaterialsTech) org.exolab.castor.xml.Unmarshaller.unmarshal(eu.dca.model.EventMaterialsTech.class, reader);
    }
