...
/**
 * Definition: A concept to index materials and/or technique.How to
 * record: Preferably taken from a published controlled vocabulary.
 * 
 * @version $Revision$ $Date$
 */
@SuppressWarnings("serial")
public class TermMaterialsTech extends eu.dca.model.ConceptComplexType 
implements java.io.Serializable
{
    ...
    /**
     * How to record: Example values: technique, material,
     * implement, mark (e.g., watermark or other mark inherent in
     * the material)
     */
     ...
     * following description: How to record: Example values:
     * technique, material, implement, mark (e.g., watermark or
     * other mark inherent in the material)
     * 
     ...
     * @throws org.exolab.castor.xml.ValidationException if this
     * object is an invalid instance according to the schema
     * @return the unmarshaled eu.dca.model.TermMaterialsTech
     */
    public static eu.dca.model.TermMaterialsTech unmarshal(
            final java.io.Reader reader)
    throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (eu.dca.model.TermMaterialsTech) org.exolab.castor.xml.Unmarshaller.unmarshal(eu.dca.model.TermMaterialsTech.class, reader);
    }
