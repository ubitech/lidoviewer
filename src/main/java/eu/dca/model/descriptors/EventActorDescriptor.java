...
/**
 * Class EventActorDescriptor.
 * 
 * @version $Revision$ $Date$
 */
public class EventActorDescriptor extends eu.dca.model.descriptors.ActorInRoleSetComplexTypeDescriptor {
    ...
    public EventActorDescriptor() {
        super();
        setExtendsWithoutFlatten(new eu.dca.model.descriptors.ActorInRoleSetComplexTypeDescriptor());
        ...
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            ...
            {
                EventActor target = (EventActor) object;
    ...
    public java.lang.Class getJavaClass(
        ...
        return eu.dca.model.EventActor.class;
    }
