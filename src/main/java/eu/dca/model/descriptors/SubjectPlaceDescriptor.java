...
import eu.dca.model.SubjectPlace;

/**
 * Class SubjectPlaceDescriptor.
 * 
 * @version $Revision$ $Date$
 */
public class SubjectPlaceDescriptor extends eu.dca.model.descriptors.PlaceSetComplexTypeDescriptor {
    ...
    public SubjectPlaceDescriptor() {
        super();
        setExtendsWithoutFlatten(new eu.dca.model.descriptors.PlaceSetComplexTypeDescriptor());
        _nsURI = "http://www.lido-schema.org";
        _xmlName = "subjectPlace";
        ...
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            ...
            {
                SubjectPlace target = (SubjectPlace) object;
    ...
    public java.lang.Class getJavaClass(
        ...
        return eu.dca.model.SubjectPlace.class;
    }
