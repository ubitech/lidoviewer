...
import eu.dca.model.SubjectActor;

/**
 * Class SubjectActorDescriptor.
 * 
 * @version $Revision$ $Date$
 */
public class SubjectActorDescriptor extends eu.dca.model.descriptors.ActorSetComplexTypeDescriptor {
    ...
    public SubjectActorDescriptor() {
        super();
        setExtendsWithoutFlatten(new eu.dca.model.descriptors.ActorSetComplexTypeDescriptor());
        _nsURI = "http://www.lido-schema.org";
        _xmlName = "subjectActor";
        ...
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            ...
            {
                SubjectActor target = (SubjectActor) object;
    ...
    public java.lang.Class getJavaClass(
        ...
        return eu.dca.model.SubjectActor.class;
    }
