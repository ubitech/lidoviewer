...
import eu.dca.model.RelatedEventSet;

/**
 * Class RelatedEventSetDescriptor.
 * 
 * @version $Revision$ $Date$
 */
public class RelatedEventSetDescriptor extends eu.dca.model.descriptors.RelatedEventSetComplexTypeDescriptor {
    ...
    public RelatedEventSetDescriptor() {
        super();
        setExtendsWithoutFlatten(new eu.dca.model.descriptors.RelatedEventSetComplexTypeDescriptor());
        _nsURI = "http://www.lido-schema.org";
        _xmlName = "relatedEventSet";
        ...
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            ...
            {
                RelatedEventSet target = (RelatedEventSet) object;
    ...
    public java.lang.Class getJavaClass(
        ...
        return eu.dca.model.RelatedEventSet.class;
    }
