...
import eu.dca.model.QualifierMeasurements;

/**
 * Class QualifierMeasurementsDescriptor.
 * 
 * @version $Revision$ $Date$
 */
public class QualifierMeasurementsDescriptor extends eu.dca.model.descriptors.TextComplexTypeDescriptor {
    ...
    public QualifierMeasurementsDescriptor() {
        super();
        setExtendsWithoutFlatten(new eu.dca.model.descriptors.TextComplexTypeDescriptor());
        _nsURI = "http://www.lido-schema.org";
        _xmlName = "qualifierMeasurements";
        ...
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            ...
            {
                QualifierMeasurements target = (QualifierMeasurements) object;
    ...
    public java.lang.Class getJavaClass(
        ...
        return eu.dca.model.QualifierMeasurements.class;
    }
