...
import eu.dca.model.SubjectDate;

/**
 * Class SubjectDateDescriptor.
 * 
 * @version $Revision$ $Date$
 */
public class SubjectDateDescriptor extends eu.dca.model.descriptors.DateSetComplexTypeDescriptor {
    ...
    public SubjectDateDescriptor() {
        super();
        setExtendsWithoutFlatten(new eu.dca.model.descriptors.DateSetComplexTypeDescriptor());
        _nsURI = "http://www.lido-schema.org";
        _xmlName = "subjectDate";
        ...
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            ...
            {
                SubjectDate target = (SubjectDate) object;
    ...
    public java.lang.Class getJavaClass(
        ...
        return eu.dca.model.SubjectDate.class;
    }
