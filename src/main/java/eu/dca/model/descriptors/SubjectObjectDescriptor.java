...
import eu.dca.model.SubjectObject;

/**
 * Class SubjectObjectDescriptor.
 * 
 * @version $Revision$ $Date$
 */
public class SubjectObjectDescriptor extends eu.dca.model.descriptors.ObjectSetComplexTypeDescriptor {
    ...
    public SubjectObjectDescriptor() {
        super();
        setExtendsWithoutFlatten(new eu.dca.model.descriptors.ObjectSetComplexTypeDescriptor());
        _nsURI = "http://www.lido-schema.org";
        _xmlName = "subjectObject";
        ...
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            ...
            {
                SubjectObject target = (SubjectObject) object;
    ...
    public java.lang.Class getJavaClass(
        ...
        return eu.dca.model.SubjectObject.class;
    }
