...
import eu.dca.model.RelatedWorkSet;

/**
 * Class RelatedWorkSetDescriptor.
 * 
 * @version $Revision$ $Date$
 */
public class RelatedWorkSetDescriptor extends eu.dca.model.descriptors.RelatedWorkSetComplexTypeDescriptor {
    ...
    public RelatedWorkSetDescriptor() {
        super();
        setExtendsWithoutFlatten(new eu.dca.model.descriptors.RelatedWorkSetComplexTypeDescriptor());
        _nsURI = "http://www.lido-schema.org";
        _xmlName = "relatedWorkSet";
        ...
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            ...
            {
                RelatedWorkSet target = (RelatedWorkSet) object;
    ...
    public java.lang.Class getJavaClass(
        ...
        return eu.dca.model.RelatedWorkSet.class;
    }
