 ...
 */
public class GmlDescriptor extends eu.dca.model.descriptors.GmlComplexTypeDescriptor {
    ...
    public GmlDescriptor() {
        super();
        setExtendsWithoutFlatten(new eu.dca.model.descriptors.GmlComplexTypeDescriptor());
