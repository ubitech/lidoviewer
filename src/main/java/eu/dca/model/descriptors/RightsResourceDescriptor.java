...
import eu.dca.model.RightsResource;

/**
 * Class RightsResourceDescriptor.
 * 
 * @version $Revision$ $Date$
 */
public class RightsResourceDescriptor extends eu.dca.model.descriptors.RightsComplexTypeDescriptor {
    ...
    public RightsResourceDescriptor() {
        super();
        setExtendsWithoutFlatten(new eu.dca.model.descriptors.RightsComplexTypeDescriptor());
        _nsURI = "http://www.lido-schema.org";
        _xmlName = "rightsResource";
        ...
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            ...
            {
                RightsResource target = (RightsResource) object;
    ...
    public java.lang.Class getJavaClass(
        ...
        return eu.dca.model.RightsResource.class;
    }
