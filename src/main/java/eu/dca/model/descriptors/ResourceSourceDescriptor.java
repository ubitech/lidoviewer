...
import eu.dca.model.ResourceSource;

/**
 * Class ResourceSourceDescriptor.
 * 
 * @version $Revision$ $Date$
 */
public class ResourceSourceDescriptor extends eu.dca.model.descriptors.LegalBodyRefComplexTypeDescriptor {
    ...
    public ResourceSourceDescriptor() {
        super();
        setExtendsWithoutFlatten(new eu.dca.model.descriptors.LegalBodyRefComplexTypeDescriptor());
        _nsURI = "http://www.lido-schema.org";
        _xmlName = "resourceSource";
        ...
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            ...
            {
                ResourceSource target = (ResourceSource) object;
    ...
    public java.lang.Class getJavaClass(
        ...
        return eu.dca.model.ResourceSource.class;
    }
