...
import eu.dca.model.TermMaterialsTech;

/**
 * Class TermMaterialsTechDescriptor.
 * 
 * @version $Revision$ $Date$
 */
public class TermMaterialsTechDescriptor extends eu.dca.model.descriptors.ConceptComplexTypeDescriptor {
    ...
    public TermMaterialsTechDescriptor() {
        super();
        setExtendsWithoutFlatten(new eu.dca.model.descriptors.ConceptComplexTypeDescriptor());
        _nsURI = "http://www.lido-schema.org";
        _xmlName = "termMaterialsTech";
        ...
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            ...
            {
                TermMaterialsTech target = (TermMaterialsTech) object;
    ...
    public java.lang.Class getJavaClass(
        ...
        return eu.dca.model.TermMaterialsTech.class;
    }
