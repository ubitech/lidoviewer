...
import eu.dca.model.EventMaterialsTech;

/**
 * Class EventMaterialsTechDescriptor.
 * 
 * @version $Revision$ $Date$
 */
public class EventMaterialsTechDescriptor extends eu.dca.model.descriptors.MaterialsTechSetComplexTypeDescriptor {
    ...
    public EventMaterialsTechDescriptor() {
        super();
        setExtendsWithoutFlatten(new eu.dca.model.descriptors.MaterialsTechSetComplexTypeDescriptor());
        _nsURI = "http://www.lido-schema.org";
        _xmlName = "eventMaterialsTech";
        ...
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            ...
            {
                EventMaterialsTech target = (EventMaterialsTech) object;
    ...
    public java.lang.Class getJavaClass(
        ...
        return eu.dca.model.EventMaterialsTech.class;
    }
