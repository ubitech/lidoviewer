 ...
 */
public class ResourceSetDescriptor extends eu.dca.model.descriptors.ResourceSetComplexTypeDescriptor {
    ...
    public ResourceSetDescriptor() {
        super();
        setExtendsWithoutFlatten(new eu.dca.model.descriptors.ResourceSetComplexTypeDescriptor());
        _nsURI = "http://www.lido-schema.org";
        _xmlName = "resourceSet";
        ...
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            ...
            {
                ResourceSet target = (ResourceSet) object;
    ...
    public java.lang.Class getJavaClass(
        ...
        return eu.dca.model.ResourceSet.class;
    }
