...
/**
 * Class SubjectSetDescriptor.
 * 
 * @version $Revision$ $Date$
 */
public class SubjectSetDescriptor extends eu.dca.model.descriptors.SubjectSetComplexTypeDescriptor {
    ...
    public SubjectSetDescriptor() {
        super();
        setExtendsWithoutFlatten(new eu.dca.model.descriptors.SubjectSetComplexTypeDescriptor());
        ...
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            ...
            {
                SubjectSet target = (SubjectSet) object;
    ...
    public java.lang.Class getJavaClass(
        ...
        return eu.dca.model.SubjectSet.class;
    }
