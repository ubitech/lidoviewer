...
/**
 * Definition: A person, group, or institution depicted in or by an
 * object / work, or what it is about, provided as display and
 * index elements. 
 * 
 * @version $Revision$ $Date$
 */
@SuppressWarnings("serial")
public class SubjectActor extends eu.dca.model.ActorSetComplexType 
implements java.io.Serializable
{
     ...
     * @throws org.exolab.castor.xml.ValidationException if this
     * object is an invalid instance according to the schema
     * @return the unmarshaled eu.dca.model.SubjectActor
     */
    public static eu.dca.model.SubjectActor unmarshal(
            final java.io.Reader reader)
    throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (eu.dca.model.SubjectActor) org.exolab.castor.xml.Unmarshaller.unmarshal(eu.dca.model.SubjectActor.class, reader);
    }
