...
/**
 * Definition: Wrapper for one title or object name and its source
 * information.How to record: Mandatory. If there is no specific
 * title, provide an object name in the appellation value. If there
 * is more than one title, repeat the Title Set element.Notes: For
 * objects from natural, technical, cultural history e.g. the
 * object name given here and the object type, recorded in the
 * object / work type element are often identical. 
 * 
 * @version $Revision$ $Date$
 */
@SuppressWarnings("serial")
public class TitleSet extends eu.dca.model.AppellationComplexType 
implements java.io.Serializable
{
     ...
     * @throws org.exolab.castor.xml.ValidationException if this
     * object is an invalid instance according to the schema
     * @return the unmarshaled eu.dca.model.TitleSet
     */
    public static eu.dca.model.TitleSet unmarshal(
            final java.io.Reader reader)
    throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (eu.dca.model.TitleSet) org.exolab.castor.xml.Unmarshaller.unmarshal(eu.dca.model.TitleSet.class, reader);
    }
