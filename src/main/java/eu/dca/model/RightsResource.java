 ...
 * other resource. How to record: Use this sub-element if the
 * holder of the reproduction rights for the image/resource differs
 * from the holder of rights for the work. See also Rights Work
 * above. (E.g., the work rights are " National Museum of African
 * Art, Smithsonian Instituition (Washing DC), " but the image
 * rights are "Photo Frank Khoury.")
 * 
 * @version $Revision$ $Date$
 */
@SuppressWarnings("serial")
public class RightsResource extends eu.dca.model.RightsComplexType 
implements java.io.Serializable
{
     ...
     * @throws org.exolab.castor.xml.ValidationException if this
     * object is an invalid instance according to the schema
     * @return the unmarshaled eu.dca.model.RightsResource
     */
    public static eu.dca.model.RightsResource unmarshal(
            final java.io.Reader reader)
    throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (eu.dca.model.RightsResource) org.exolab.castor.xml.Unmarshaller.unmarshal(eu.dca.model.RightsResource.class, reader);
    }
