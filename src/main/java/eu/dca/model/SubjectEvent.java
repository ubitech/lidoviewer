...
/**
 * Definition: An event depicted in or by an object / work, or what
 * it is about, provided as display and index elements. 
 * 
 * @version $Revision$ $Date$
 */
@SuppressWarnings("serial")
public class SubjectEvent extends eu.dca.model.EventSetComplexType 
implements java.io.Serializable
{
     ...
     * @throws org.exolab.castor.xml.ValidationException if this
     * object is an invalid instance according to the schema
     * @return the unmarshaled eu.dca.model.SubjectEvent
     */
    public static eu.dca.model.SubjectEvent unmarshal(
            final java.io.Reader reader)
    throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (eu.dca.model.SubjectEvent) org.exolab.castor.xml.Unmarshaller.unmarshal(eu.dca.model.SubjectEvent.class, reader);
    }
