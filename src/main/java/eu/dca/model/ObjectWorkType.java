 ...
 * How to record: Preferably taken from a published controlled
 * vocabulary. For a collection, include repeating instances for
 * identifying all of or the most important items in the
 * collection.
 * 
 * @version $Revision$ $Date$
 */
@SuppressWarnings("serial")
public class ObjectWorkType extends eu.dca.model.ConceptComplexType 
implements java.io.Serializable
{
     ...
     * @throws org.exolab.castor.xml.ValidationException if this
     * object is an invalid instance according to the schema
     * @return the unmarshaled eu.dca.model.ObjectWorkType
     */
    public static eu.dca.model.ObjectWorkType unmarshal(
            final java.io.Reader reader)
    throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (eu.dca.model.ObjectWorkType) org.exolab.castor.xml.Unmarshaller.unmarshal(eu.dca.model.ObjectWorkType.class, reader);
    }
