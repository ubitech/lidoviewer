 ...
 * shapes (e.g., an oval painting).How to record: Example values:
 * oval, round, square, rectangular, and irregular.
 * 
 * @version $Revision$ $Date$
 */
@SuppressWarnings("serial")
public class ShapeMeasurements extends eu.dca.model.TextComplexType 
implements java.io.Serializable
{
    ...
    public ShapeMeasurements(final java.lang.String defaultValue) {
        try {
     ...
     * @throws org.exolab.castor.xml.ValidationException if this
     * object is an invalid instance according to the schema
     * @return the unmarshaled eu.dca.model.ShapeMeasurements
     */
    public static eu.dca.model.ShapeMeasurements unmarshal(
            final java.io.Reader reader)
    throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (eu.dca.model.ShapeMeasurements) org.exolab.castor.xml.Unmarshaller.unmarshal(eu.dca.model.ShapeMeasurements.class, reader);
    }
