...
/**
 * Definition: Name of a culture, cultural context, people, or also
 * a nationality. How to record: Preferably using a controlled
 * vocabuarly. 
 * 
 * @version $Revision$ $Date$
 */
@SuppressWarnings("serial")
public class Culture extends eu.dca.model.ConceptComplexType 
implements java.io.Serializable
{
     ...
     * @throws org.exolab.castor.xml.ValidationException if this
     * object is an invalid instance according to the schema
     * @return the unmarshaled eu.dca.model.Culture
     */
    public static eu.dca.model.Culture unmarshal(
            final java.io.Reader reader)
    throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (eu.dca.model.Culture) org.exolab.castor.xml.Unmarshaller.unmarshal(eu.dca.model.Culture.class, reader);
    }
