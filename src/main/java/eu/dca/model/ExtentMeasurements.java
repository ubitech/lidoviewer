 ...
 * being measured included, when necessary, for clarity.How to
 * record: Example values: overall, components, sheet, plate mark,
 * chain lines, pattern repeat, lid, base, laid lines, folios,
 * leaves, columns per page, lines per page, tessera, footprint,
 * panel, interior, mat, window of mat, secondary support, frame,
 * and mount
 * 
 * @version $Revision$ $Date$
 */
@SuppressWarnings("serial")
public class ExtentMeasurements extends eu.dca.model.TextComplexType 
implements java.io.Serializable
{
    ...
    public ExtentMeasurements(final java.lang.String defaultValue) {
        try {
     ...
     * @throws org.exolab.castor.xml.ValidationException if this
     * object is an invalid instance according to the schema
     * @return the unmarshaled eu.dca.model.ExtentMeasurements
     */
    public static eu.dca.model.ExtentMeasurements unmarshal(
            final java.io.Reader reader)
    throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (eu.dca.model.ExtentMeasurements) org.exolab.castor.xml.Unmarshaller.unmarshal(eu.dca.model.ExtentMeasurements.class, reader);
    }
