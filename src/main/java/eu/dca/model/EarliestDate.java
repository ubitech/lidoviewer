 ...
 * beginning of an implied date span. How to record: General
 * format: YYYY[-MM[-DD]]Format is according to ISO 8601. This may
 * include date and time specification. 
 * 
 * @version $Revision$ $Date$
 */
@SuppressWarnings("serial")
public class EarliestDate implements java.io.Serializable {
     ...
     * exact or an estimated earliest date.
     */
    ...
    public EarliestDate(final java.lang.String defaultValue) {
        try {
     ...
     * date, e.g. if it is an exact or an estimated earliest date.
     * 
     ...
     * @throws org.exolab.castor.xml.ValidationException if this
     * object is an invalid instance according to the schema
     * @return the unmarshaled eu.dca.model.EarliestDate
     */
    public static eu.dca.model.EarliestDate unmarshal(
            final java.io.Reader reader)
    throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (eu.dca.model.EarliestDate) org.exolab.castor.xml.Unmarshaller.unmarshal(eu.dca.model.EarliestDate.class, reader);
    }
