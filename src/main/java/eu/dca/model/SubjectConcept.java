 ...
 * subject of the described object / work. How to record: May
 * include iconography, themes from literature, or generic terms
 * describing the material world, or topics (e.g., concepts,
 * themes, or issues). However, references to people, dates,
 * events, places, objects are indicated in the the respective
 * sub-elements Subject Actor Set, Subject Date Set, Subject Event
 * Set, Subject Place Set, and Subject Object Set.Preferably taken
 * from a published controlled vocabulary. 
 * 
 * @version $Revision$ $Date$
 */
@SuppressWarnings("serial")
public class SubjectConcept extends eu.dca.model.ConceptComplexType 
implements java.io.Serializable
{
     ...
     * @throws org.exolab.castor.xml.ValidationException if this
     * object is an invalid instance according to the schema
     * @return the unmarshaled eu.dca.model.SubjectConcept
     */
    public static eu.dca.model.SubjectConcept unmarshal(
            final java.io.Reader reader)
    throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (eu.dca.model.SubjectConcept) org.exolab.castor.xml.Unmarshaller.unmarshal(eu.dca.model.SubjectConcept.class, reader);
    }
