...
/**
 * Definition: The method by which the event is carried out. How to
 * record: Preferably taken from a published controlled
 * vocabulary.Notes: Used e.g. for SPECTRUM Units of Information
 * "field collection method", "acquisition method".
 * 
 * @version $Revision$ $Date$
 */
@SuppressWarnings("serial")
public class EventMethod extends eu.dca.model.ConceptComplexType 
implements java.io.Serializable
{
     ...
     * @throws org.exolab.castor.xml.ValidationException if this
     * object is an invalid instance according to the schema
     * @return the unmarshaled eu.dca.model.EventMethod
     */
    public static eu.dca.model.EventMethod unmarshal(
            final java.io.Reader reader)
    throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (eu.dca.model.EventMethod) org.exolab.castor.xml.Unmarshaller.unmarshal(eu.dca.model.EventMethod.class, reader);
    }
