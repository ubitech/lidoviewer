...
/**
 * Definition: Appellations, e.g. titles, identifying phrases, or
 * names given to an item, but also name of a person or
 * corporation, also place name etc. How to record: Repeat this
 * element only for language variants.
 * 
 * @version $Revision$ $Date$
 */
@SuppressWarnings("serial")
public class AppellationValue implements java.io.Serializable {
    ...
    public AppellationValue(final java.lang.String defaultValue) {
        try {
     ...
     * @throws org.exolab.castor.xml.ValidationException if this
     * object is an invalid instance according to the schema
     * @return the unmarshaled eu.dca.model.AppellationValue
     */
    public static eu.dca.model.AppellationValue unmarshal(
            final java.io.Reader reader)
    throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (eu.dca.model.AppellationValue) org.exolab.castor.xml.Unmarshaller.unmarshal(eu.dca.model.AppellationValue.class, reader);
    }
