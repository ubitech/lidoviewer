 ...
 * repository from which the image or other resource was obtained.
 * How to record: Include this sub-element when the source of the
 * image/resource differs from the source named in Record Source.
 * 
 * @version $Revision$ $Date$
 */
@SuppressWarnings("serial")
public class ResourceSource extends eu.dca.model.LegalBodyRefComplexType 
implements java.io.Serializable
{
     ...
     * @throws org.exolab.castor.xml.ValidationException if this
     * object is an invalid instance according to the schema
     * @return the unmarshaled eu.dca.model.ResourceSource
     */
    public static eu.dca.model.ResourceSource unmarshal(
            final java.io.Reader reader)
    throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (eu.dca.model.ResourceSource) org.exolab.castor.xml.Unmarshaller.unmarshal(eu.dca.model.ResourceSource.class, reader);
    }
