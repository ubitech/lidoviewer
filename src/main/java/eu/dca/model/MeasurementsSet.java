 ...
 * of an object / work (e.g., width).How to record: May be combined
 * with extent, qualifier, and other sub-elements as necessary.The
 * subelements "measurementUnit", "measurementValue" and
 * "measurementType" are mandatory.
 * 
 * @version $Revision$ $Date$
 */
@SuppressWarnings("serial")
public class MeasurementsSet extends eu.dca.model.MeasurementsSetComplexType 
implements java.io.Serializable
{
     ...
     * @throws org.exolab.castor.xml.ValidationException if this
     * object is an invalid instance according to the schema
     * @return the unmarshaled eu.dca.model.MeasurementsSet
     */
    public static eu.dca.model.MeasurementsSet unmarshal(
            final java.io.Reader reader)
    throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (eu.dca.model.MeasurementsSet) org.exolab.castor.xml.Unmarshaller.unmarshal(eu.dca.model.MeasurementsSet.class, reader);
    }
