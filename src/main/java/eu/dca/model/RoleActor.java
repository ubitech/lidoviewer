...
/**
 * Definition: Role of the Actor in the event. How to record:
 * Preferably taken from a published controlled vocabulary. 
 * 
 * @version $Revision$ $Date$
 */
@SuppressWarnings("serial")
public class RoleActor extends eu.dca.model.ConceptComplexType 
implements java.io.Serializable
{
     ...
     * @throws org.exolab.castor.xml.ValidationException if this
     * object is an invalid instance according to the schema
     * @return the unmarshaled eu.dca.model.RoleActor
     */
    public static eu.dca.model.RoleActor unmarshal(
            final java.io.Reader reader)
    throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (eu.dca.model.RoleActor) org.exolab.castor.xml.Unmarshaller.unmarshal(eu.dca.model.RoleActor.class, reader);
    }
