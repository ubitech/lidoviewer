...
/**
 * Definition: References an event which is linked in some way to
 * this event, e.g. a field trip within which this object was
 * collected. 
 * 
 * @version $Revision$ $Date$
 */
@SuppressWarnings("serial")
public class RelatedEventSet extends eu.dca.model.RelatedEventSetComplexType 
implements java.io.Serializable
{
     ...
     * @throws org.exolab.castor.xml.ValidationException if this
     * object is an invalid instance according to the schema
     * @return the unmarshaled eu.dca.model.RelatedEventSet
     */
    public static eu.dca.model.RelatedEventSet unmarshal(
            final java.io.Reader reader)
    throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (eu.dca.model.RelatedEventSet) org.exolab.castor.xml.Unmarshaller.unmarshal(eu.dca.model.RelatedEventSet.class, reader);
    }
